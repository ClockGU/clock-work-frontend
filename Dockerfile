...
ARG VITE_PUBLIC_URL
ARG VITE_WEBSOCKET_URI

ENV VITE_ALLOWED_HOST=${VITE_ALLOWED_HOST} VITE_AUTH_API=${VITE_AUTH_API} VITE_CONTENT_API=${VITE_CONTENT_API} VITE_PUBLIC_URL=${VITE_PUBLIC_URL} VITE_WEBSOCKET_URI=${VITE_WEBSOCKET_URI}
