StudentInstructionTextGerman.vue
<script setup></script>
...
<template>
  <v-card-text>
    ...
    <p>
      In addition to your personal data (address, bank details), you will need
      the following documents: current certificate of enrollment, ELStAM form,
