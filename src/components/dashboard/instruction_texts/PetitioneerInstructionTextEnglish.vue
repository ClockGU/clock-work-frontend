...
<template>
  <v-card-text>
    <h3>
      Here you can start an application to hire a new student assistant and view
    ...
    <p></p>
    <p>
      In addition to the usual contract information, you will need the S-number
      (HRZ account) of the student assistant and the email address of the person
      responsible for the cost center.
    </p>
    <p>An application cannot be saved if mandatory fields are left blank!</p>
    <p>
