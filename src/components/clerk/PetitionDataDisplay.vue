<template>
    <v-card class="pa-4 w-100" elevation="2">
        <v-card-title class="mt-2 mb-4">Petition Data display</v-card-title>
        <v-card-text>
            <v-row>
            ...
            <div class="d-flex flex-columns justify-space-around mt-6">
                <v-btn color="error" size="large" class="px-10" @click="decline">
                    Decline
                </v-btn>
                <v-btn color="success" size="large" class="px-10" @click="accept">
                    Accept
                </v-btn>
            </div>
        </v-card-text>
