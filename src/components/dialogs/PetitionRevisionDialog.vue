<template>
  <CustomDialog 
    v-model="model"
    :title="$t('actions.requestChange')">
    <template #content>
      <v-card-text>
        <v-row class="mb-4">
           <!-- Instructions -->
          <v-col cols="12" sm="12">
            <p class="text-body-1 text-justify text-medium-emphasis px-10 mb-2 mt-6">
...
import { mdiEmailOutline, mdiMessageTextOutline, mdiAccountOutline } from '@mdi/js';
