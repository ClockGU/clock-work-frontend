...
<template>
  ...
  <svg width="100%" viewBox="0 0 785 110" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(0,6)" class="st1">
      ...
      <!-- C (left) -->
      <path d="M49,0C22,0,0,22,0,49c0,26.6,22,48.2,49,48.2c9.9,0,19.8-3.3,28.1-9.2l0.6-0.4V70.6l-2.6,2.6
      ...
      <!-- L -->
      <polygon points="104.9,1.6 91.8,1.6 91.8,95.6 130,95.6 130,83.2 104.9,83.2"/>
      <!-- O -->
      <g transform="translate(181.1,52)">
        <g id="cog1" class="clock-cog-rotation">
          ...
          <rect x="-5" y="-51" width="10" height="12" rx="2" transform="rotate(13)"/>
          <rect x="-5" y="-51" width="10" height="12" rx="2" transform="rotate(58)"/>
          <rect x="-5" y="-51" width="10" height="12" rx="2" transform="rotate(108)"/>
          <rect x="-5" y="-51" width="10" height="12" rx="2" transform="rotate(148)"/>
          <rect x="-5" y="-51" width="10" height="12" rx="2" transform="rotate(193)"/>
          <rect x="-5" y="-51" width="10" height="12" rx="2" transform="rotate(238)"/>
          <rect x="-5" y="-51" width="10" height="12" rx="2" transform="rotate(283)"/>
          <rect x="-5" y="-51" width="10" height="12" rx="2" transform="rotate(328)"/>
      ...
      <!-- c (right C) -->
      <path d="M284.9,0c-27,0-49,22-49,49c0,26.6,22,48.2,49,48.2c9.9,0,19.8-3.3,28.1-9.2l0.6-0.4V70.6l-2.6,2.6
      ...
      <!-- k -->
      <polygon points="351.1,45.5 395.5,1.6 377.6,1.6 340.9,38.4 340.9,1.6 327.8,1.6 327.8,95.6 340.9,95.6
    ...
    <g transform="translate(414,6)" fill="#C0392B">
      ...
      <g transform="translate(212,1)">
        <path  d="M0,0 H38 C58,0 72,12 72,31 C72,45 63,55 49,60 L76,94 H61 L36,63 H10 V94 H0 Z M10,10 V53 H37 C50,53 61,45 61,31 C61,17 50,10 37,10 Z"/>
      </g>

      <!-- k: starts at 214+52+10=276, width ~70 -->
      <g transform="translate(302,1)">
        <polygon points="23.3,43.9 69,0 49.8,0 13.1,36.8 13.1,0 0,0 0,94 13.1,94 13.1,53.9 14.1,52.9 50.3,93.5 50.8,94 69,94"/>
      </g>
    </g>
  </svg>
  </div>
